...
int main(int argc, char *argv[])
{
    ...
    while (true)
    {
        ...
        for (int i = 0; i < candidate_count; i++)
        {
            printf("The number of votes for candidate %s is %i. \n", candidates[i].name,candidates[i].votes);
        }
        */
    ...
    for (int i = 0; i < candidate_count; i++)
    {
        printf("Name: %s Vote: %i ",candidates[i].name,candidates[i].votes);
    }
    */
    return 0;
}
